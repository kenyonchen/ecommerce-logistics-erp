...
public class KafkaEventConsumer {
    ...
    public KafkaEventConsumer(LogisticsApplicationService logisticsApplicationService,
    ...
    public void handleOrderCreatedEvent(OrderCreatedEvent event) {
        log.info("从Kafka接收到订单创建事件: {}", event.getOrderId());
    ...
    public void handleOrderStatusChangedEvent(OrderStatusChangedEvent event) {
        log.info("从Kafka接收到订单状态变更事件: {} 从 {} 到 {}",
     ...
     */
    @KafkaListener(topics = "logistics-events", groupId = "finance-group")
    public void handleLogisticsCompletedEvent(LogisticsCompletedEvent event) {
        log.info("从Kafka接收到物流完成事件: {}", event.getLogisticsOrderId());
     ...
     */
    @KafkaListener(topics = "inventory-events", groupId = "purchase-group")
    public void handleInventoryShortageEvent(InventoryShortageEvent event) {
        log.info("从Kafka接收到库存不足事件: 产品 {} 在仓库 {} 数量 {}",
